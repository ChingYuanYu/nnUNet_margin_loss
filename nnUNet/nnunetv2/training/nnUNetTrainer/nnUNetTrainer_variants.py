...
class nnUNetTrainerMICCAI_margin_loss(nnUNetTrainerMICCAI):
...
class nnUNetTrainerMICCAI_repvgg_decode(nnUNetTrainerMICCAI):
    @staticmethod
    def build_network_architecture(architecture_class_name: str,
                                   arch_init_kwargs: dict,
                                   arch_init_kwargs_req_import: Union[List[str], Tuple[str, ...]],
...
class nnUNetTrainerMICCAI_repvgg702_decode(nnUNetTrainerMICCAI):
    @staticmethod
    def build_network_architecture(architecture_class_name: str,
                                   arch_init_kwargs: dict,
                                   arch_init_kwargs_req_import: Union[List[str], Tuple[str, ...]],
        ...
        convs_per_stage = ['stackedconv', 'stackedconv', 'stackedconv', 'stackedconv', 'stackedconv', 'stackedconv']
